...
if __name__ == '__main__':
    dataset = 20
    x = np.load(f"./output/{dataset}_optimized_path.npy")
    ...
    plt.title(f"occupancy map for pose optimized dataset {dataset}")
    plt.savefig(f"./output/{dataset}_occupancy_mapping_optimized.png")
    plt.show()
    plt.pause(10)